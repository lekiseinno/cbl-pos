...
<div id="panel-item-list">
	<div class="row" style="margin: 0;">
		<div class="col-3 padding-l-0 padding-r-0">
			...
			$sql		=	"
							SELECT		TOP 5
										[CBL-front-store].[dbo].[item\$].[Item_screen],
										[CBL-front-store].[dbo].[item\$].[Item_pattern],
										[CBL-front-store].[dbo].[Item_pattern].[Item_Pattern_Name]
							FROM		[CBL-front-store].[dbo].[item\$]
							INNER JOIN	[CBL-front-store].[dbo].[Item_pattern]	ON	[CBL-front-store].[dbo].[Item_pattern].[Item_Pattern_Code]	=	[CBL-front-store].[dbo].[item\$].[Item_pattern]
							INNER JOIN	[CBL-front-store].[dbo].[Item_screen]	ON	[CBL-front-store].[dbo].[Item_screen].[Item_Screen_Code]	=	[CBL-front-store].[dbo].[item\$].[Item_screen]
							WHERE		[CBL-front-store].[dbo].[Item_pattern].[Item_Pattern_Code]	>	0
							AND			[CBL-front-store].[dbo].[Item_screen].[Item_Screen_Code]	>	0
							AND			LEN([CBL-front-store].[dbo].[item\$].[Item_No]) = 20
							/* Start is test */
							AND			[CBL-front-store].[dbo].[Item_pattern].[Item_Pattern_Name]	=	'SX'
							/* End is test */
													...
													<div class="row">
														<div class="col-6">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_type('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_type['item_type']); ?>')">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_cotton('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_cotton['Item_cotton']); ?>')">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_color('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_color['Item_color']); ?>')">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_arm('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_arm['Item_arm']); ?>')">
														...
														<div class="col-6">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_bag('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_bag['Item_bag']); ?>')">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_acc('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_acc['Item_accessory']); ?>')">
															...
															<div class="btn-group-toggle" data-toggle="buttons">
																...
																{
																	?>
																	<label class="btn btn-outline-primary btn-sm " onclick="select_size('<?php echo $row['Item_Pattern_Name']; ?>','<?php echo sprintf("%04d",$row['Item_screen']); ?>','<?php echo sprintf("%02d",$row_size['Item_size']); ?>')">
